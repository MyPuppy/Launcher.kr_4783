...
namespace RiderData
{
    public static class NewRider
    {
        ...
        {
            NewRider.Kart_V1_Cut = 8;
            NewRider.Kart_X_Cut = 103;
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1292 || i == 1293 || i == 1294 || i == 1296 || i == 1299 || i == 1300 || i == 1301 || i == 1303 || i == 1306 || i == 1307 || i == 1308 || i == 1309 || i == 1338 || //X

                        i == 1305 || i == 1310 || i == 1311 || i == 1336 || i == 1337 || i == 1339 || i == 1340 || i == 1341) //V1
                    {
